        ...
        <div className="relative flex items-center justify-center bg-white dark:bg-gray-900 text-gray-800 dark:text-white/90">
          <div className="w-3/5">
            ...
            <div className="font-medium text-base pb-8 text-gray-500 dark:text-gray-400">
              Sign in to continue your access pages
            </div>
            <form>
              ...
              <ButtonBasic name={"Sign in"} type="submit" link="" className="cursor-pointer mt-5 w-full bg-blue-500 hover:bg-blue-700 py-2.5 rounded-lg font-semibold transition-colors text-neutral-100" />
            </form>
          </div>
          <ThemeModeButton />
        </div>
